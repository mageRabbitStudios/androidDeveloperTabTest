...
class FetchComicsUseCaseImplTest {
    ...
    @Mock private lateinit var mockComicsRepository: ComicRepository
    @Mock private lateinit var mockScheduleProvider: SchedulerProvider

    private lateinit var subject: FetchComicsUseCaseImpl

    @Mock private lateinit var mockScheduler: Scheduler
    @Mock private lateinit var mockResponse: List<Comic>
