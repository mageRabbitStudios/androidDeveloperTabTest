...
import com.example.stanislavkinzl.tabtestupdateddep.injection.objects.AOkHttpMockInterceptor
...
class AMockNetworkModule {
    ...
    fun provideOkHttpClient(httpLoggingInterceptor: HttpLoggingInterceptor): OkHttpClient =
        OkHttpClient.Builder()
            ...
            .addInterceptor(AOkHttpMockInterceptor())
            .build()
